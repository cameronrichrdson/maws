...
3. Download the 'libraries' folder. These are the packages required for the software, in the correct version. You must move them to the path: '/Users/Your Username/Documents/Arduino'. If there is an existing 'libraries' folder then overwrite existing packages that are already installed.
